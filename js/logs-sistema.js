window.initModVinculado = function() {
  ...
  window.cargarMarcasPV = function() {
    ...
    // Re-validar al cambiar tipo
    if (window.reValidarCamposVehiculoMod) window.reValidarCamposVehiculoMod();
  };
  ...
  function mostrarPanelSeleccion(resultados, valorBuscado) {
    ...
    resultados.forEach((res, index) => {
      ...
      card.innerHTML = `
        ...
        <button class="btn-seleccionar" data-index="${index}" style="padding: 12px 24px; background: ${res.color}; color: white; border: none; border-radius: 6px; font-weight: 700; cursor: pointer; white-space: nowrap;">✏️ Editar</button>
      `;
  ...
  // ==========================================
  // 🔹 9. VALIDACIÓN EN TIEMPO REAL (ESPECÍFICA POR TIPO)
  // ==========================================
