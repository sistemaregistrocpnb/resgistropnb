    ...
    window.initRegDenuncias = function() {
        ...
        function iniciarModulo(intentos = 0) {
            ...
            const isoMap = {
                ...
                "Congo":"cg","Corea del Norte":"kp","Corea del Sur":"kr","Costa de Marfil":"ci",
                "Costa Rica":"cr","Croacia":"hr","Cuba":"cu","Dinamarca":"dk","Dominica":"dm",
                "Ecuador":"ec","Egipto":"eg","El Salvador":"sv","Emiratos Árabes":"ae","Eritrea":"er",
            ...
            form.addEventListener('submit', async (e) => {
                ...
                try {
                    ...
                    // ✅ OBTENER TELÉFONO DIRECTAMENTE DEL SELECT
                    ...
                    if (typeof window.registrarLog === 'function') {
                        ...
                        const logDetalles = {
                            registro: 'Denuncia Registrada', estatus: 'Activa',
                            numero_denuncia: nuevoNumeroDenuncia, estacion_policial: data.estacion_policial || 'N/A',
                            cedula_denunciante: data.cedula || 'N/A', nombre_denunciante: nombreDenunciante,
                            telefono: telefonoCompleto, direccion: data.direccion || 'N/A',
                            motivo: data.motivo_denuncia || 'N/A', documentos_subidos: totalDocs,
                            email_registrante: user.email
                        };

                        await window.registrarLog('REGISTRAR', 'DENUNCIAS', logDetalles, insertedData?.id || null);
