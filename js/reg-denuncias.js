window.initRegDenuncias = function() {
    ...
    if (optionsBox && nativeSelect && displayBox) {
        console.log("✅ Elementos del dropdown de teléfono encontrados. Generando banderas...");
        ...
        console.error("❌ ERROR: No se encontraron los elementos del dropdown de teléfono. Verifica que los IDs en el HTML sean: d_tlf_pais, d-tlf-flag-img, d-tlf-code-text, d-tlf-country-text");
    }
        // ==========================================
