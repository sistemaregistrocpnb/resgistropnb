console.log("✅ elim-vinculados.js cargado correctamente");
            ...
            if (typeof window.registrarLog === 'function' && currentData?.id) {
                await window.registrarLog(
                    ...
                    'VINCULADOS',
                    {
                        ...
                        placa: currentData.placa,
                        marca: currentData.marca_vehiculo,
                        modelo: currentData.modelo_vehiculo,
                        ...
                        direccion_detencion: currentData.direccion_detencion,
                        descripcion_eliminada: `Registro vinculado (${currentData.tipo_vehiculo || ''} ${currentData.marca_vehiculo || ''} ${currentData.modelo_vehiculo || ''}) eliminado del sistema activo por ${eliminadoPor}`
                    },
                    currentData.id
                );
                console.log('✅ Log de eliminación de registro vinculado registrado');
            }
    ...
    async function reintegrarRegistro() {
        ...
        try {
            ...
            if (typeof window.registrarLog === 'function' && currentData?.id) {
                ...
                console.log('✅ Log de reintegración de registro vinculado registrado');
            }
