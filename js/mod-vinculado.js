window.initModVinculado = function() {
    ...
    // ==========================================
    // 🔹 4. DROPDOWN DE BANDERAS (AGREGADO)
    // ==========================================
    ...
    // ==========================================
    // 🔹 5. PREVISUALIZACIÓN DE FOTOS (AGREGADO)
    // ==========================================
    ...
    // ==========================================
    // 🔹 6. BÚSQUEDA Y LLENADO (con .limit(1) para evitar error PGRST116)
    // ==========================================
    ...
    if (btnBuscar && inputBusqueda) {
        ...
        btnBuscar.addEventListener('click', async () => {
            ...
            try {
                // ✅ Usamos .limit(1) para evitar error PGRST116 con duplicados
    ...
    setupEdad();
    setupValidation();
    initPhoneDropdown(); // ← Activa las banderas
